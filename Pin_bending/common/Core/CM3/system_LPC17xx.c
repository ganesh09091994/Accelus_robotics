...
/*
//the Multiplier Value is bits 0-14 and the value stored is one less than the desired multiplier.
//Here the multiplier is 63h ie 99  	
//the pre-Divider value is 5
//from the equation for sec. 4.5.10 of user manual of lpc1768
//	the pll o/p freq is (2*M*Fin)/N
*/
#define PLL1_SETUP            1
