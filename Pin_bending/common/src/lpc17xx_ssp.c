...
static void setSSPclock (LPC_SSP_TypeDef *SSPx, uint32_t target_clock)
{
    ...
    // // CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
...
void SSP_ConfigStructInit(SSP_CFG_Type *SSP_InitStruct)
{
	...
	SSP_InitStruct->ClockRate = 8000000;
...
{
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_FUNCTIONALSTATE(NewState));
...
{
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSP_STAT(FlagType));
...
{
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSP_INTSTAT_RAW(RawIntType));
...
{
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSP_INTSTAT(IntType));
...
{
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSP_INTCLR(IntType));
...
{
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSPx(SSPx));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_SSP_DMA(DMAMode));
	// CHECK_PARAM(PARAM_SSPx(SSPx));(PARAM_FUNCTIONALSTATE(NewState));
