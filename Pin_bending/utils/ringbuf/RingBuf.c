...
* NOTES:       none
*****************************************************************************/
static unsigned Ringbuf_Count (RING_BUFFER const *b){
...
* NOTES:       none
*****************************************************************************/
static bool Ringbuf_Full (RING_BUFFER const *b){
...
* NOTES:       none
*****************************************************************************/
uint8_t *Ringbuf_Get_Front(RING_BUFFER const *b){
    if (b) {
...
* NOTES:       none
*****************************************************************************/
bool Ringbuf_Put(RING_BUFFER * b,uint8_t *data_element){     /* ring buffer structure */
...
void Ringbuf_Init(RING_BUFFER * b,  uint8_t *data, unsigned element_size, unsigned element_count){
...
void testRingBuf(    Test * pTest,uint8_t *data_store,uint8_t *data_element,unsigned element_size,unsigned element_count){
...
void testRingBufSize16(Test * pTest){
...
void testRingBufSize32(Test * pTest){
